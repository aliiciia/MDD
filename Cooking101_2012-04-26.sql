...
# Database: Cooking101
# Generation Time: 2012-04-26 13:41:52 +0000
# ************************************************************
...
CREATE TABLE `ingredient` (
  ...
  `quanity` varchar(11) NOT NULL DEFAULT '',
  `measurement` varchar(150) NOT NULL DEFAULT '',
...
VALUES
	...
	(9,1,'','','Chocolate Ganache, for topping'),
	...
	(18,3,'2','','yellow squash, cut in 12 chunks'),
	(19,3,'12','','mushroom , cut in half'),
	(20,3,'4','','scallions, cut in 1-inch pieces'),
	(21,3,'12','','cherry tomatoes'),
	(22,4,'1','pkg','lasagna noodles'),
	(23,4,'4','cup','ricotta cheese'),
	(24,4,'1/4','cup','grated Parmesan cheese'),
	(25,4,'4','lg','eggs'),
	(26,4,'','','Salt and pepper to taste'),
	...
	(37,5,'2','','garlic cloves, minced'),
	(38,5,'2','tsp','chili powder'),
	(39,5,'1/2','tsp','salt'),
	(40,5,'16','','corn tortillas'),
	(41,5,'4','','ripe avocados, peeled, seeded and sliced'),
	(42,5,'1','cup','salsa'),
